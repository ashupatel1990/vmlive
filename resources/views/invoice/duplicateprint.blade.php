...
.blueheader { background-color: #0692cd; border-bottom: 1px solid #000; }
.terms { color: #e01345;  }
.conditions { color: #0692cd; }
.fs15 { font-size: 15px; }
.fs16 { font-size: 16px; }
tr td ul {
    padding-bottom: 50px;
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card-box">
                ...
                <div class="clearfix">
                    <table style="width:100%; margin-top: 100px;" border="1" class="bill-table">
                        <tr>
                            <td style="width:50%">
                                <table>
                                    <tr>
                                        <td style="padding-left: 40px;"><img src="{{asset('assets/images/visionlogo-wb.png')}}" width="130"></td>
                        ...
                        <tr class="billed-to">
                            <td colspan="5" class="mb-2 fs15" style="padding: 10px;">
                                ...
                                @if($invoice->customer_no)<span><b style="color:#000; ">Mobile:</b>&nbsp;{{$invoice->customer_no}}</span> @endif
                            </td>
                        </tr>
                        <tr>
                            <td colspan="5">
                                <table style="width:100%;" class="item_details">
                                    <thead class="blueheader">
                                        <tr>
                                            <th align="center" style="width:10%; color:#000; background-color: #0692cd; border-right: 1px solid; text-align:left; padding-left: 5px;">Sr.No.</th>
                                            <th align="center" style="width:60%; color:#000; background-color: #0692cd; border-right: 1px solid; padding-top: 10px; padding-bottom: 10px;">PARTICULARS</th>
                                            <th align="center" style="width:10%; color:#000; background-color: #0692cd; border-right: 1px solid;">QTY.</th>
                                            <th align="center" style="width:10%; color:#000; background-color: #0692cd; border-right: 1px solid;">RATE</th>
                                            <th align="center" style="width:15%; color:#000; background-color: #0692cd;">AMOUNT(INR)</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td style="width:10%; color:#000; border-right: 1px solid;">1</td>
                                            <td style="width:60%; color:#000; border-right: 1px solid; padding: 20px 10px;">@php echo nl2br($invoice->item_description) @endphp</td>
                                            <td style="width:10%; color:#000; border-right: 1px solid; text-align:center;">1</td>
                                            <td style="width:10%; color:#000; border-right: 1px solid;text-align:right; padding-right:20px;">₹{{$duplicateInvoice->new_amount}}</td>
                                            <td style="width:15%; color:#000; text-align:right; padding-right:10px;">₹{{$duplicateInvoice->new_amount}}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
                                ...
                                <table style="width:100%;" class="tax_details" border="0">
                                    <tbody>
                                        <tr style="border-bottom: 1px solid #000;">
                                            <td colspan="4" align="right" style="padding-top: 6px; padding-bottom: 6px;"><h4>Total:</h4></td>
                                            <td style="width:15%; color:#000; text-align:right; padding-right:10px; padding-top: 6px; padding-bottom: 6px;"><b>₹{{ $duplicateInvoice->new_amount }}</b></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td colspan="4" align="right" style="padding-top: 6px; padding-bottom: 6px;"><h4>Net Total:</h4></td>
                                            <td style="width:15%; color:#000; text-align:right; padding-right:10px; border-top: 1px solid; padding-top: 6px; padding-bottom: 6px;"><h4 style="color:#000">₹{{ $duplicateInvoice->new_amount }}</h4></td>
                                        </tr>
                                        @endif
                        ...
                        <tr style="background-color:#0692cd; color: #000" class="blueheader">
                        ...
                        <tr>
                            <td colspan="4" style="padding-left: 20px; padding-top: 50px;">
                                ...
                                <p class="thanks-text" style="text-align: center; font-weight: 700;">Thanks for Visit! </p>
                            </td>
                        </tr>
                    </table>
